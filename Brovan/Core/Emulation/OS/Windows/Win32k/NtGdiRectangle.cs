...
{
    internal class NtGdiRectangle : IWinSyscall
    {
        public NTSTATUS Handle(BinaryEmulator Instance)
        {
            ...
            Instance.WinHelper.EnqueueGdiShape(Hwnd, GdiPrimitiveKind.Rectangle, Left, Top, Right, Bottom, Pen.ColorRef, Pen.PenWidth, Brush.ColorRef);
